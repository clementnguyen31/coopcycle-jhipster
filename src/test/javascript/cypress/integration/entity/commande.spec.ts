...
describe('Commande e2e test', () => {
  ...
  describe('new Commande page', () => {
    ...
    it('should create an instance of Commande', () => {
      cy.get(`[data-cy="commandeId"]`).type('16850').should('have.value', '16850');

      cy.get(`[data-cy="commandeLieu"]`).type('Loan generate Cloned').should('have.value', 'Loan generate Cloned');

      cy.get(`[data-cy="commandeEcheance"]`).type('calculating Savings').should('have.value', 'calculating Savings');

      cy.get(`[data-cy="commandeLibelle"]`).type('Caumartin Wooden Montmorency').should('have.value', 'Caumartin Wooden Montmorency');
