...
class CommandeResourceIT {
    ...
    private static final String DEFAULT_COMMANDE_LIEU = "AAAAAAAAAA";
    private static final String UPDATED_COMMANDE_LIEU = "BBBBBBBBBB";

    private static final String DEFAULT_COMMANDE_ECHEANCE = "AAAAAAAAAA";
    private static final String UPDATED_COMMANDE_ECHEANCE = "BBBBBBBBBB";

    private static final String DEFAULT_COMMANDE_LIBELLE = "AAAAAAAAAA";
    private static final String UPDATED_COMMANDE_LIBELLE = "BBBBBBBBBB";
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande()
            ...
            .commandeLieu(DEFAULT_COMMANDE_LIEU)
            .commandeEcheance(DEFAULT_COMMANDE_ECHEANCE)
            .commandeLibelle(DEFAULT_COMMANDE_LIBELLE);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande()
            ...
            .commandeLieu(UPDATED_COMMANDE_LIEU)
            .commandeEcheance(UPDATED_COMMANDE_ECHEANCE)
            .commandeLibelle(UPDATED_COMMANDE_LIBELLE);
        return commande;
    }
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getCommandeLieu()).isEqualTo(DEFAULT_COMMANDE_LIEU);
        assertThat(testCommande.getCommandeEcheance()).isEqualTo(DEFAULT_COMMANDE_ECHEANCE);
        assertThat(testCommande.getCommandeLibelle()).isEqualTo(DEFAULT_COMMANDE_LIBELLE);
    }
    ...
    void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.[*].commandeLieu").value(hasItem(DEFAULT_COMMANDE_LIEU)))
            .andExpect(jsonPath("$.[*].commandeEcheance").value(hasItem(DEFAULT_COMMANDE_ECHEANCE)))
            .andExpect(jsonPath("$.[*].commandeLibelle").value(hasItem(DEFAULT_COMMANDE_LIBELLE)));
    }
    ...
    void getCommande() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.commandeLieu").value(DEFAULT_COMMANDE_LIEU))
            .andExpect(jsonPath("$.commandeEcheance").value(DEFAULT_COMMANDE_ECHEANCE))
            .andExpect(jsonPath("$.commandeLibelle").value(DEFAULT_COMMANDE_LIBELLE));
    }
    ...
    void putNewCommande() throws Exception {
        ...
        assertThat(testCommande.getCommandeLieu()).isEqualTo(UPDATED_COMMANDE_LIEU);
        assertThat(testCommande.getCommandeEcheance()).isEqualTo(UPDATED_COMMANDE_ECHEANCE);
        assertThat(testCommande.getCommandeLibelle()).isEqualTo(UPDATED_COMMANDE_LIBELLE);
    }
    ...
    void partialUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.commandeId(UPDATED_COMMANDE_ID).commandeLibelle(UPDATED_COMMANDE_LIBELLE);
