    ...
    public ResponseEntity<Cooperative> partialUpdateCooperative(
        ...
        Optional<Cooperative> result = cooperativeRepository
            ...
            .map(existingCooperative -> {
                ...
                if (cooperative.getCooperativeNom() != null) {
                    existingCooperative.setCooperativeNom(cooperative.getCooperativeNom());
                }
                if (cooperative.getCooperativeDirecteur() != null) {
                    existingCooperative.setCooperativeDirecteur(cooperative.getCooperativeDirecteur());
                }
                if (cooperative.getCooperativeVille() != null) {
                    existingCooperative.setCooperativeVille(cooperative.getCooperativeVille());
                }
                if (cooperative.getCooperativeMetropole() != null) {
                    existingCooperative.setCooperativeMetropole(cooperative.getCooperativeMetropole());
                }
                if (cooperative.getCooperativeCommune() != null) {
                    existingCooperative.setCooperativeCommune(cooperative.getCooperativeCommune());
                }
