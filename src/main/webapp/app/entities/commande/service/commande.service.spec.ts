...
describe('Commande Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      commandeId: 0,
      commandeLieu: 'AAAAAAA',
      commandeEcheance: 'AAAAAAA',
      commandeLibelle: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          ...
          commandeId: 1,
          commandeLieu: 'BBBBBB',
          commandeEcheance: 'BBBBBB',
          commandeLibelle: 'BBBBBB',
        },
        elemDefault
      );
    ...
    describe('addCommandeToCollectionIfMissing', () => {
      ...
      it('should add only unique Commande to an array', () => {
        const commandeArray: ICommande[] = [{ id: 123 }, { id: 456 }, { id: 81089 }];
