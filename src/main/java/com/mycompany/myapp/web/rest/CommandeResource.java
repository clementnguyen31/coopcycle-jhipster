    ...
    public ResponseEntity<Commande> partialUpdateCommande(
        ...
        Optional<Commande> result = commandeRepository
            ...
            .map(existingCommande -> {
                ...
                if (commande.getCommandeLieu() != null) {
                    existingCommande.setCommandeLieu(commande.getCommandeLieu());
                }
                if (commande.getCommandeEcheance() != null) {
                    existingCommande.setCommandeEcheance(commande.getCommandeEcheance());
                }
                if (commande.getCommandeLibelle() != null) {
                    existingCommande.setCommandeLibelle(commande.getCommandeLibelle());
                }
