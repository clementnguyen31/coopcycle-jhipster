...
describe('Cooperative Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      cooperativeId: 0,
      cooperativeNom: 'AAAAAAA',
      cooperativeDirecteur: 'AAAAAAA',
      cooperativeVille: 'AAAAAAA',
      cooperativeMetropole: 'AAAAAAA',
      cooperativeCommune: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          id: 1,
          cooperativeId: 1,
          cooperativeNom: 'BBBBBB',
          cooperativeDirecteur: 'BBBBBB',
          cooperativeVille: 'BBBBBB',
          cooperativeMetropole: 'BBBBBB',
          cooperativeCommune: 'BBBBBB',
        },
        elemDefault
      );
    ...
    describe('addCooperativeToCollectionIfMissing', () => {
      ...
      it('should add only unique Cooperative to an array', () => {
        const cooperativeArray: ICooperative[] = [{ id: 123 }, { id: 456 }, { id: 2938 }];
